...
void kill_screen(const char* lcd_msg) {
  ...
  inline void line_to_z(const float &z) {
    ...
    void lcd_sdcard_pause() 
    {
      ...
      enqueue_and_echo_commands_P(PSTR("G1 F1200 X0 Y0"));
    ...
    void lcd_sdcard_stop() 
    {
      ...
      void lcd_sdcard_power_resume()
      {
        ...
        dtostrf(pause_z, 3, 2, pause_str_Z);
        SERIAL_PROTOCOLLN(pause_str_Z);
        SERIAL_PROTOCOLLN("lcd_sdcard_power_resume() pause_str_Z");
  ...
  void lcd_control_menu() {
    ...
    #if ENABLED(EEPROM_SETTINGS)
      MENU_ITEM(submenu, MSG_INIT_EEPROM, lcd_init_eeprom);
    #endif
   ...
   */
    ...
    void lcd_info_printer_menu() {
      ...
      STATIC_ITEM(MACHINE_NAME, true);                                 // Ender-5 Pro
